...
__global__ void mcmc_dnorm_padding(double *y_data_input_d[], double *y_ode_agg_d[],
...
__global__ void mcmc_print_iter(int iter);
...
__global__  void mcmc_update_parameters_with_norm_sd(GPUParameters* gpu_params_d,
                                                          FluParameters* flu_params_current_d, FluParameters* flu_params_new_d,
                                                          double* norm_sd_d);
__global__ void mcmc_check_acceptance(double r_denom_d[], double r_num_d[],
                                      GPUParameters *gpu_params_d, FluParameters* flu_params_current_d, FluParameters* flu_params_new_d,
                                      curandState* curand_state_d);
